    ...
    <main class="my-form">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-8">
                    <div class="card">
                        <div class="card-header border border-dark" style="background-color:darkgreen">
                        ...
                        <div class="card-body border border-dark">
                            <form name="my-form" action="BuyerLogin.php" method="post">
                                ...
                                <div class="col-md-6 offset-md-4">
                                    <button type="submit" class="btn " style="background-color:darkgreen;color:Lightgreen" name="login" value="Login">
                                        Login
                                    </button>
                                </div>
                                <br>
