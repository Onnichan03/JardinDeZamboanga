...
<head>
    ...
    <script>
        function state() {
            ...
            if (a === 'ZAMBOANGA CITY') {
                var array = ['Arena Blanco', 'Ayala', 'Baliwasan', 'Baluno', 'Boalan', 'Bolong', 'Buenavista', 'Bunguiao', 'Busay', 'Cabaluay', 'Cabatangan', 'Cacao', 'Calabasa', 'Calarian', 'Camino Nuevo', 'Campo Islam', 'Canelar', 'Capisan', 'Capisan', 'Cawit', 'Culianan', 'Curuan', 'Divisoria', 'Guisao', 'Guiwan', 'Kasanyangan', 'La Paz', 'Lamisahan', 'Landang Laum', 'Lanzones', 'Lapakan', 'Latuan', 'Licomo', 'Limpapa', 'Limaong', 'Lumayang', 'Lumabangan', 'Lunzuran', 'Maasin', 'Mampang', 'Manicahan', 'Mariki', 'Mercedes', 'Pangapuyan', 'Panubigan', 'Pasonanca', 'Patalon', 'Putik', 'Recodo', 'Salaan', 'San Jose Cawa-Cawa', 'San Jose Gusu', 'San Roque', 'Sangali', 'Santa Barabara', 'Santa Catanlina', 'Santa Maria', 'Santo Nino', 'Sibulao', 'Sinubong', 'Sinunuc', 'Tagasilay', 'Taguiti', 'Talisayan', 'Talon-Talon', 'Taluksangay', 'Tetuan', 'Tictapul', 'Tigbalabag', 'Tictabon', 'Tolosa', 'Tugbungan', 'Tumalutap', 'Victoria', 'Vitali', 'Zambowood'];
...
<main class="my-form">
		<div class="cotainer">
			<div class="row justify-content-center">
				<div class="col-md-8">
					<div class="card">
						<div class="card-header" style="background-color:darkgreen"><h4 style="font-style:bold;color:lightgreen">Farmer Registration<h4></div>
						<div class="card-body border border-dark">
							<form name="my-form" action="FarmerRegister.php" method="post">
								...
								<div class="form-group row">
									...
									<div class="col-md-6">
										<input type="number" id="phone_number" class="form-control border border-dark" name="phonenumber" placeholder="Phone Number" required>
									</div>
								</div>

                                <div class="form-group row">
									<label for="gender" class="col-md-4 col-form-label text-md-right"><i class="fas fa-phone-alt mr-2"></i><b>Genders</b></label>
									<div class="col-md-6">
										<select name="gender" id="gender" class="form-control border border-dark" required>
                                ...
                                <div class="form-group row">
                                    <label for="states" class="col-md-4 col-form-label text-md-right"><b><i class="fas fa-globe-americas mr-2"></i>City</b></label>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    <label for="states" class="col-md-4 col-form-label text-md-right"><b><i class="fas fa-globe-americas mr-2"></i>Baranagay</b></label>
                                    <div class="col-md-6">
								...
								<div class="col-md-6 offset-md-4">
									<button type="submit" class="btn btn-primary " style="background-color:Darkgreen;color:lightgreen"   name="register" value="Register">
										Register
									</button>
								</div>
							</form>
...
if (isset($_POST['register'])) {
    ...
    if (strcmp($password, $confirmpassword) == 0) {
        ...
        $query = "insert into farmerregistration (farmer_name,farmer_phone, gender,
                farmer_address, farmer_state, farmer_district,
                farmer_pan,farmer_bank,farmer_password) 
                values ('$name','$phonenumber', '$gender','$address',
