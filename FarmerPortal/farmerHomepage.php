      ...
      <body>
           ...
           <nav class="navbar navbar-expand-xl ">
                ...
                <button class="navbar-toggler" data-toggle="collapse" style="margin-left:-20px;" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
                     <span class="navbar-toggler-icon"><i class="fas fa-bars p-1 " style="color:white;font-size:20px; "></i></span>
                </button>
                ...
                <div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
                     <div class="carousel-inner">
                          <div class="carousel-item active">
                               <img class="d-block w-100 resizing" src="../Images/Homepage/bg3.png" alt="First slide">
                          </div>
                          <div class="carousel-item">
                               <img class="d-block w-100 resizing" src="../Images/Homepage/bg-3.jpg" alt="Third slide">
                          </div>
                          <div class="carousel-item">
                               <img class="d-block w-100 resizing" src="../Images/Homepage/bg_2.jpg" alt="Second slide">
                          </div>
           ...
           <div class="features container">
                ...
                <div class="card-deck row text-center" style="display: flex; flex-wrap: wrap;">
                     <div class="card">
                          <p class="aligncenter">
                               <img class="card-img-top image" src="../Images/Homepage/mobile application.png" alt="Card image cap" width="250px" height="200px">
                          </p>
                          <div class="card-body">
                               <h4 class="card-title font-weight-bold">Mobile Application </h4>
                               <br>
                               <h5 class="card-text">Upload and Edit Your Products via Mobile Application </h5>
                          </div>
                     </div>
                     <div class="card">
                          <p class="aligncenter">
                               <img class="card-img-top image" src="../Images/Homepage/shakehands.png" alt="Card image cap" width="250px" height="200px">
                          </p>
                          <div class="card-body">
                     ...
                     <div class="card">
                          <p class="aligncenter">
                               <img class="card-img-top image" src="../Images/Homepage/farmers.png" alt="Card image cap" width="250px" height="200px">
                          </p>
                          <div class="card-body">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 mt-2 mt-sm-2 text-center">
                    <p><u><a href="">Jardin de Zamboanga</a></u> is a Multitrading Company for farmers and traders</p>
                    <p class="h6">Copy All right Reversed.<a class="text-green ml-2" href="" target="_blank">WEBDEV</a></p>
                </div>
                </hr>
            </div>
        </div>
