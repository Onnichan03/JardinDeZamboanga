...
$username = "root";
$password = "12345678";
$database = "Jardin_De_Zamboanga_db";
...
// Replace 'product_id' and 'desired_product_id' with your actual table and criteria
$product_id = 1; // Change this to the desired product ID
$sql = "SELECT product_expiry FROM products WHERE product_id = $product_id";
...
if ($result->num_rows > 0)
    ...
    // Display the product_expiry value
                    ...
                    <tbody>
                         ...
                         ?>
                                             <tr>
                                                  ...
                                                  <td data-label="Product Expiration"><?php echo $product_expiry ?></td>
