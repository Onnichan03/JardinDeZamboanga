...
<body>
     ...
     <body>
               ...
               <div class="card-body">
                    ...
                    <div class="card-deck">
                         <div class="card">
                              ...
                              <div class="card-body">
                                   <h5 class="card-title font-weight-bold text-center">SMS Contact</h5>
                                   <p class="card-text">Ralph Alejandro: 09755231733 Jesa Cano: 999999999 Rosenie ignacio: 88888888 Jessa hedoqiuo: 777777777</p>
                              </div>
                         </div>
                         <div class="card">

                              <div class="card-body">
                                   <h5 class="card-title font-weight-bold text-center">Social Media Account</h5>
                                   <p class="card-text">facebook: Ralph Alejandro, Jessa Cano, Rosenie Ignacio, Jessa hedoqiuo.</p>
                              </div>
                         </div>
                         <div class="card">

                              <div class="card-body">
                                   <h5 class="card-title font-weight-bold text-center">Admin Contact</h5>
                                   <p class="card-text">Ralph Alejandro : 097552317733 Jesa Cano: 999999999 Rosenie ignacio: 88888888 Jessa hedoqiuo: 777777777</p>
                                   <p></p>
                                   <p></p>
                              </div>
                         </div>
          ...
          <div style="display:block;">
               ...
               <br>
               <h4 align="center">Toll Free Number : 09755231733</h4>
               <br>
