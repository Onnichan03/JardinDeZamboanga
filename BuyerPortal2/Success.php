...
<div class=" flex-row-reverse right ">
    ...
    <div class="text-success  login">Login</div>
       ...
       <div class="card">
            ...
            <div class="card-body">
                 <h4 class="card-title text-success text-center font-weight-bold">Placeorder Successfully </h4>
                 <?php
...
if (isset($_GET['ref'])) {
    ...
    if ($result) {
        ...
        echo "<h4 class='card-title text-success text-center font-weight-bold'>Order Confirmation</h2>";
        echo "<h5>Thank you for your order! Your reference number is: $referenceNumber</p>";
        echo "<h5>Product Name: $product_title</p>";
        echo "<h5>Quantity: $quantity</p>";
        echo "<h5>Total Amount: $totalAmount</p>";
        echo "<h5>Delivery Method: $deliveryMethod</p>";
        echo "</div>";
