...
<nav class="navbar navbar-expand-xl ">
        ...
        <div class=" flex-row-reverse left ">
            ...
            <div class="p-2">
                <div class="icon2">
                    <a href="CartPage.php"> <i class="fa" style="font-size:30px; color:darkgreen;margin-top:2px;">&#61562;</i></a>
        ...
        <div class="row">
            <div class="col-12 col-sm-12 col-md-12 col-lg-3 col-xl-3 ">
                <div class="card border-dark border" >
                    <div class="card-body ">
                        ...
                        <h4 class="card-subtitle mb-2  text-center">Ralph Alejandro</h4>
                        <p class="card-text text-center">Mampang<br><br>
                            <button type="button" class="btn  border-dark border" style="background-color:green;color:white">View Profile </button>
                        </p>
            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-3 col-xl-3 ">
                <div class="card border-dark border" >
                    <div class="card-body ">
                        ...
                        <h4 class="card-subtitle mb-2  text-center">Jessa Cano</h4>
                        <p class="card-text text-center">Baliwasan<br><br>
                            <button type="button" class="btn  border-dark border" style="background-color:green;color:white">View Profile </button>
                        </p>
                        <!-- <a href="#" class="card-link text-center">Card link</a>
                      <a href="#" class="card-link text-center">Another link</a> -->
            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-3 col-xl-3 ">
                <div class="card border-dark border" >
                    <div class="card-body ">
                        ...
                        <h4 class="card-subtitle mb-2  text-center">Jessa Hedoquio</h4>
                        <p class="card-text text-center">Caragasan<br><br>
                            <button type="button" class="btn  border-dark border" style="background-color:green;color:white">View Profile </button>
                        </p>
                        <!-- <a href="#" class="card-link text-center">Card link</a>
                      <a href="#" class="card-link text-center">Another link</a> -->
            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-3 col-xl-3 ">
                <div class="card border-dark border" >
                    <div class="card-body ">
                        <h5 class="card-title text-center"><img src="iconbig4.png" style=" margin-bottom:  10px;"></h5>
                        <h4 class="card-subtitle mb-2  text-center">Rosenie Ignacio</h4>
                        <p class="card-text text-center">Pasonanca<br><br>
                            <button type="button" class="btn  border-dark border" style="background-color:green;color:white">View Profile </button>
                        </p>
                        <!-- <a href="#" class="card-link text-center">Card link</a>
                      <a href="#" class="card-link text-center">Another link</a> -->
