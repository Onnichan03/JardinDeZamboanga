...
<div class=" flex-row-reverse left ">
    ...
    <a class="float-left" href="bhome.php">
        <img src="bg3.png" class="float-left mr-5 ml-0 " alt="Logo" style="height:50px;">
    </a>
</div>
...
<a class="float-left" href="bhome.php">
    <img src="bg3.png" class="float-left mr-2 moblogo" alt="Logo" style="height:50px;">
</a>
                        ...
                        <div class="row">
                            <div class="col-md-12" style="margin-top:35px;">
                                <span style="padding:15px;">
                                    <h4 id="full_name" class=""><img src="iconsmall.png" style="width: 28px; margin-bottom:  10px;"><b> Ralph Anthony Alejandro</b></h4>
                                </span>
                                <span style="padding:15px;">
                                    <h4 id="full_name" style="margin-left:-9%;"><img src="phoneicon.jpg" style="width: 32px; margin-bottom:  10px;"><b>09755231733 </b></h4>
                                </span>
                                <span style="padding:15px;">
                                    <h4 id="full_name" class=""><img src="location.jpg" style="width: 32px; margin-bottom:  10px;"><b> Zamboanga City, Mampang</b></h4>
                                </span>
                            </div>
                        </div>
					</div>
