...
<div class=" flex-row-reverse left ">
    ...
    <div class="p-2 ml-5"><i class='far fa-user-circle' style='font-size:30px; color: white;margin-top:2px;'></i></div>
    <a class="float-left" href="bhome.php">
        <img src="bg.png" class="float-left mr-5 ml-0 " alt="Logo" style="height:50px;">
    </a>
</div>
<button class="navbar-toggler" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
    <span class="navbar-toggler-icon"><i class="fas fa-bars p-1 " style="color:white;margin-right:-9%;font-size:28px;"></i></span>
</button>
<a class="float-left" href="bhome.php">
    <img src="bg.png" class="float-left mr-2 moblogo" alt="Logo" style="height:50px;">
</a>
...
<div class=" flex-row-reverse right ">
    ...
    <form action="checkout.php" method="post">
        ...
        <div class="container mt-2">
            ...
            <form>
                <div class=" float-none float-sm-none float-md-none float-lg-right float-xl-rightcheckout mr-0 p-2 mb-5   " style="border-radius:5%;">
                    <h4 style="font-family: sans-serif"><b>Grand total = Php. <?php echo $_SESSION['grandtotal']; ?> </b></h4>
                </div>
                <div class="input-group mt-2 hey ">
                    <div class="input-group-prepend ">
                        <span class="input-group-text" style="background-color:green;color:white`">Delivery Address</span>
                    </div>
        ...
        <div class="container mt-5">
            ...
            <div class="payment">
                <h4>Payment Options :-
                    <input type="radio" aria-label="Radio button for following text input" name="payment" value="gcash" required>
                    ...
                    <img src="../Images/Website/cod.png" class="cod" style="height:37px">
                </h4>
            </div>

            <div class="float-none float-sm-none float-md-none float-lg-right float-xl-right placeorder">
                <a href="#"><button type="submit" name="submit" class="btn btn-lg  border border-dark " style="font-size:22px;color:white;background-color:green">
                        Place Order
    ...
    <div class="float-none float-sm-none float-md-none float-lg-right float-xl-right goback ">
        <a href="cartpage.php"><button type="button" class="btn btn-lg  border border-dark  " style="font-size:22px;color:white;background-color:green;margin-left:-8%;">
        ...
        <div class="container">
            <div class="row text-center text-xs-center text-sm-left text-md-left">
                <div class="col aligncenter">
                    ...
                    <img src="  gcash.png" alt="gcash">
                    <img src="../Images/Website/cod.png" style="height:37px">
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 mt-2 mt-sm-5">
                    <ul class="list-unstyled list-inline social text-center">
                        <li class="list-inline-item"><a href="https://www.facebook.com/profile.php?id=61552686610624"><i class="fa fa-facebook"></i></a></li>
                        <li class="list-inline-item"><a href="javascript:void();"><i class="fa fa-twitter"></i></a></li>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 mt-2 mt-sm-2 text-center">
                    <p><u><a href="https://www.facebook.com/profile.php?id=61552686610624">Jardin de Zamboanga</a></u> is a Multitrading Company for farmers and traders</p>
                    <p class="h6">Copy All right Reversed.<a class="text-green ml-2" href="https://www.facebook.com/profile.php?id=61552686610624" target="_blank">WEBDEV</a></p>
                </div>
                </hr>
            </div>
        </div>
...
if (isset($_POST['submit'])) {
    ...
    // Generate a reference number using timestamp and a random number
    $referenceNumber = 'REF' . time() . mt_rand(1000, 9999);
    ...
    while ($count < $i) {
        ...
        // Fetch the product title from the database based on the product_id
        ...
        if ($product_result && $product_row = mysqli_fetch_assoc($product_result)) {
            ...
            $query1 = "INSERT INTO orders (product_id, product_title, qty, address, delivery, phonenumber, total, payment, buyer_phonenumber, referencenumber) VALUES ('$product_id', '$product_title', '$qty', '$address', '$delivery', '$phone', '$total', '$payment', '$sess_phone_number','$referenceNumber')";
    ...
    if ($run) {
        ...
        if ($payment == 'gcash') {
            echo "<script>window.location.href='gcash.php'</script>";
        } elseif ($payment == 'cod') {
            echo "<script>window.location.href='success.php?ref=$referenceNumber'</script>";
        } else {
